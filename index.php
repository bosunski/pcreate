    ...
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-sm btn-outline-secondary" href="https://getbootstrap.com/docs/4.1/examples/blog/#">Sign up</a>
            </div>
        </div>
    </header>
...
<script>window.jQuery || document.write('<script src="/jsjquery-slim.min.js"><\/script>')</script>
...
<svg xmlns="http://www.w3.org/2000/svg" width="200" height="250" viewBox="0 0 200 250" preserveAspectRatio="none" style="display: none; visibility: hidden; position: absolute; top: -100%; left: -100%;"><defs><style type="text/css"></style></defs><text x="0" y="13" style="font-weight:bold;font-size:13pt;font-family:Arial, Helvetica, Open Sans, sans-serif">Thumbnail</text></svg></body><span class="gr__tooltip"><span class="gr__tooltip-content"></span><i class="gr__tooltip-logo"></i><span class="gr__triangle"></span></span></html>